...
class hlogger final {
 public:
  /**
   * Constructor for the hlogger class, which initializes a logger object with optional
   * configuration. If no configuration is provided, it defaults to using a config_default object.
   *
