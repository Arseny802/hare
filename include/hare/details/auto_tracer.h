...
private:
   ...
   *
   * This class is used to simplify measuring the execution time of blocks of code in hare. It takes the file name and
   * function signature of the calling code, and uses them to populate the log message with relevant context.
   */
  class auto_measure final {
public:
    /**
     * @brief Constructor that initializes the logger with a specified name, file name,
     *         and function signature.
