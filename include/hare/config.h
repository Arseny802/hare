...
protected:
    ...
    /**
     * This is a protected member variable representing the masks of log types that this logger can handle.
     *
     * @see #get_types_mask
     */
    ...
    /**
     * This is a protected member variable representing the log format level for a specified logging level.
     * The log format level represents the format of the logging level that will be
     * included in logs generated by this logger, with respect to a specific logging level.
     *
     * @see #get_log_format_level
     */
